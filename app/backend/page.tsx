...
const HEALTH_CHIP_CLS: Record<HealthBand, string> = {
...
function healthChipCls(score: number): string {
  return HEALTH_CHIP_CLS[getHealthBand(score)];
}
    ...
    <AppShell showNav>
      ...
      {!loading && error && (
        <div className={styles.errorBanner}>
          <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 mt-0.5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="var(--color-danger, #c84452)" strokeWidth={2}>
