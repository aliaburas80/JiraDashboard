...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: 'Why is one tab shown first, and why do some tabs have a small dot?', a: 'Tabs are automatically sorted so the most urgent category comes first and is selected by default. Any other tab whose severity is "Needs focus" or "Needs attention" shows a small dot, so you can spot what needs review without clicking through every tab.' },
