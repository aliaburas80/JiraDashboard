...
const SECTIONS: Section[] = [
  {
    ...
    items: [
      ...
      { q: 'Step 3 — Read the dashboard top to bottom', a: 'The dashboard tells a linear story. Start at the Summary bar to see overall health. Move through the KPI cards and highlight strips. Explore the delivery composition chart, then the per-section pages (Charts, Quarters, Kanban, Sprint, Ownership, Readiness). Finish at the Flow Table for individual item detail.' },
