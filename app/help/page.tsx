...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: 'What do the specific threshold numbers mean?', a: 'Three rules compare a computed value against a fixed threshold: Scrum Master\'s "Carry-over must remain below the agreed threshold" flags At risk above 20% of committed sprint items carried over — a placeholder default, not yet a team-configurable setting; Manager\'s "Capacity overload must be corrected" flags Risk when one team member carries more than 35% load share, but only once the team has more than 2 members (the same rule the coaching insight logic uses elsewhere in the app); Manager\'s "Delivery forecasts must be credible" flags Critical below 60% overall delivery confidence. These numbers aren\'t shown next to the status pills themselves — see the Glossary\'s "Analytics Scores & UI Terms" section for the same three figures.' },
