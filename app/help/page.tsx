...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: 'I signed up myself — do I need to verify my email?', a: "Yes. After creating an account through the public registration page, you'll receive a verification email with a link. Click it (it goes to /verify-email) to confirm your address before signing in." },
      { q: 'I never received my verification email — what do I do?', a: 'Check your spam folder first. If it is missing, try signing in with your email and password; the login page will offer to send the verification email again. The verification link expires 24 hours after it is sent.' },
