...
const SECTIONS: Section[] = [
  {
    ...
    items: [
      ...
      { q: 'Step 3 — Read the dashboard top to bottom', a: 'The dashboard opens on Priority Attention (default), which also includes the Smart Actions recommendations. Use the left sidebar to navigate between 10 pages — Overview group (Priority Attention, Key Metrics, Data Quality), Delivery group (Delivery Composition, Trends), and Deep Dive group (Ownership & Capacity, Labels & Types, Epic Readiness, Flow Health Table, Coaching Insights). The 52px topbar shows the product health pill and a New Upload button.' },
