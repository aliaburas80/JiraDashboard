...
const SECTIONS: GlossarySection[] = [
  ...
  },
  {
    ...
    rows: [
      ...
      { term: 'DashboardNavSidebar',   full: 'Dashboard Fixed Sidebar',            meaning: 'Fixed 228px sidebar on /dashboard. Contains a health block (score, band, 4px progress bar, 2×2 vitals grid) and 10 nav items in 3 groups: Overview (3), Delivery (2), Deep Dive (5). Active item: #EFF6FF bg + 3px #2563EB left accent.' },
