...
| 03-clarity §A | "Confidence" (5 meanings), "At Risk" (6 meanings), "Health Score" (2 meanings), "Readiness" (2 meanings) — all undisambiguated on-page | **Proposal drafted 2026-07-14** (rename table covering 17 catalogued meanings, published as a review artifact) — awaiting owner sign-off on specific replacement labels before implementation |
