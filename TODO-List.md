...
| UX-14 Flat admin-settings UI redesign | FR-260A | GAP — not found | GAP — not found | GAP — not found | GAP — not found | v4.2.2 — "Redesigned `/admin/settings` to match the flat admin settings mockup..." | ✅ Done |
...
5. **UX items (UX-02, UX-03, UX-05, UX-11, UX-13, UX-14)**: "Default open sections", "status chips", "HTML export redesign", "advanced theme/chart customization", and especially **UX-14 (flat admin-settings redesign — the most recent, most structurally significant change)** have no UC/SCN/UJ/TC anchoring at all. **Action**: prioritize UX-14 — write a UC ("Admin Navigates the Flat Admin Console") and 2–3 `TC-AC-*` rows; backfill narrative coverage for the others.
