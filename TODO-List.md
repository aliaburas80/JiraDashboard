...
| RETRO-13 | Generate suggested next sprint actions | P2 | ✅ Done (2026-06-26) | `nextSprintSuggestions` — gated by goal outcome, blocker count, and top theme; ceremony-linked via `ceremonyRecommendations` (RETRO-29). |
...
| RETRO-29 | Build Next Sprint Suggestions section | P2 | ✅ Done (2026-06-26) | System-generated only (no manual-add UI) — rendered in the "Do This Next" section of `InsightPanel`, gated by real signals (goal outcome, blocker count, top theme); ceremony-linked via `ceremonyRecommendations`. |
