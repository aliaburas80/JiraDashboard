...
<div style="margin-top:10px;padding-top:6px;border-top:1px solid #e2e8f0;display:flex;justify-content:space-between;align-items:center;">
  <span style="font-size:8px;color:#94a3b8;">Generated by <strong style="color:#2563eb;">Delivery Clarity v4.1</strong> · ${esc(now)} · Ali Abu Ras · ali.aburas@deliveryclarity.app</span>
