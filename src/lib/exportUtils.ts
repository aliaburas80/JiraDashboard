...
<div style="background:linear-gradient(135deg,#0f172a 0%,#1e3a5f 100%);color:#fff;padding:28px 32px;">
  <div style="max-width:1100px;margin:0 auto;display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:16px;">
    <div style="display:flex;align-items:center;gap:14px;">
      ...
      <div style="width:44px;height:44px;border-radius:11px;background:linear-gradient(135deg,#1455f5,#2563eb 48%,#17b8d6);display:flex;align-items:center;justify-content:center;flex-shrink:0;box-shadow:0 6px 16px rgba(37,99,235,0.35);">
        <svg viewBox="0 0 24 24" style="width:24px;height:24px;fill:white;" aria-hidden="true"><path d="M13.7 2.3 4.8 13.1c-.5.6-.1 1.5.7 1.5h5.2l-1 6.6c-.1.8.9 1.2 1.4.6l8.1-10.5c.5-.6.1-1.5-.7-1.5h-4.8l1.4-6.8c.2-.8-.9-1.3-1.4-.7Z"/></svg>
      </div>
      <div>
        <div style="font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:.1em;color:#94a3b8;margin-bottom:2px;">Delivery Clarity</div>
        <h1 style="margin:0;font-size:24px;font-weight:900;line-height:1.2;">Delivery Report</h1>
        <p style="margin:4px 0 0;font-size:12px;color:#94a3b8;">Generated ${esc(now)}</p>
      </div>
    </div>
    <!-- Health badge -->
...
<footer style="text-align:center;padding:20px 0;border-top:1px solid #e2e8f0;margin-top:8px;">
  ...
  <p style="margin:4px 0 0;font-size:12px;color:#64748b;font-weight:600;">Ali Abu Ras · ali.aburas@deliveryclarity.app · Delivery Clarity v4.1</p>
</footer>
