...
export const PAGE_TOURS: Record<string, TourStep[]> = {
  ...
  '/dashboard/coaching': [
    ...
    },
    {
      ...
      description: 'Your role’s coaching card, shown by default — a mood/confidence banner, evidence stat chips, watch-list warnings, and recommended next actions.',
    ...
    },
    {
      id:          'other-roles',
      title:       'Other Roles',
      description: 'If your account can see more than one category, the rest stay collapsed here — expand to check another role’s view without leaving the page.',
