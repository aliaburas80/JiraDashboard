...
export const NODE_TYPE_CONFIG: Record<IssueNodeType, NodeTypeConfig> = {
  Epic:             { color: '#7c3aed', bg: '#faf5ff', border: '#a78bfa', icon: '🗺️', size: 'lg' },
  Story:            { color: '#2563eb', bg: '#eff6ff', border: '#93c5fd', icon: '📖', size: 'md' },
  Task:             { color: '#475569', bg: '#f8fafc', border: '#cbd5e1', icon: '✅', size: 'md' },
  'Sub-task':       { color: '#64748b', bg: '#f1f5f9', border: '#e2e8f0', icon: '⤷',  size: 'sm' },
  Bug:              { color: '#dc2626', bg: '#fef2f2', border: '#fca5a5', icon: '🐛', size: 'md' },
  Spike:            { color: '#d97706', bg: '#fffbeb', border: '#fcd34d', icon: '🔬', size: 'md' },
  'Technical Debt': { color: '#ea580c', bg: '#fff7ed', border: '#fdba74', icon: '⚠️', size: 'md' },
  Risk:             { color: '#9f1239', bg: '#fff1f2', border: '#fda4af', icon: '🚨', size: 'md' },
  'Change Request': { color: '#0f766e', bg: '#f0fdfa', border: '#5eead4', icon: '🔄', size: 'md' },
  Unknown:          { color: '#94a3b8', bg: '#f8fafc', border: '#e2e8f0', icon: '❓', size: 'sm' },
};
