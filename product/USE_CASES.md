...
### UC-110 — Admin Connects and Tests a Read-Only Jira API Connection

*(Added 2026-06-20 to close JIRA-04 from TODO-List.md Section 19a. ARCH-05 Phase 1 — see `product/JIRA_INTEGRATION_DESIGN.md`. In progress on `feature/arch-05-jira-integration`, unmerged.)*
